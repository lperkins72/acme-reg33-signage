...
This folder is the region-default content layer for `reg33`.
...
- `regions/reg33/data/primary-assets.json`
- `regions/reg33/data/primary.json`
- `regions/reg33/data/footer.json`
- `regions/reg33/data/primaryending.json`
- `regions/reg33/assets/primary/manifest.json`
- `regions/reg33/assets/footer/manifest.json`
...
Use this folder for region-wide defaults that should affect `reg33`.
